...
export default function Obstacles(_props: Props) {
  ...
  const material = useMemo(() => {
    ...
    return {
      ...
      // - sense-mode tints them darker
      // - sight-mode tints them completely black
      ...
      normalNode,
      // taken to black in `sight` mode HERE rather than in `colorNode`, which is only the albedo —
  ...
  const skirtMaterial = useMemo(() => {
    ...
    // and to black in `sight` mode past the lighting, as the tops are — see their `outputNode`
