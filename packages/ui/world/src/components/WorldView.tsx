    ...
    <div className="size-full">
      ...
      <AnimatePresence>
        {w.disabled && (
          ...
          >
            <div className="px-4 py-1.5 rounded-full bg-white/20 text-white/80 backdrop-blur-[2px] border border-white/40 text-xs font-mono tracking-[0.3em] uppercase select-none">
              paused
            </div>
          </motion.div>
        )}
