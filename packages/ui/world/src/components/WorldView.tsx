    ...
    <div className="size-full">
      ...
      <AnimatePresence>
        {w.disabled && (
          ...
          >
            <div className="px-6 py-2.5 rounded-full bg-black/40 backdrop-blur-xs border border-white/40 text-white/40 text-md font-mono tracking-[0.3em] uppercase select-none">
              paused
            </div>
          </motion.div>
        )}
