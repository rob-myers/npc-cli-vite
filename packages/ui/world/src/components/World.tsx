          ...
          <WorldView
            className={
              ...
              cn(
                ...
                "bg-[repeating-linear-gradient(45deg,var(--pattern-fg)_0,var(--pattern-fg)_1px,transparent_0,transparent_50%)] bg-size-[8px_8px] bg-fixed [--pattern-fg:color-mix(in_oklch,var(--color-zinc-400)_20%,transparent)]",
              )
            }
          >
            <Lights />
